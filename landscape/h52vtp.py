...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Convert h5 file to XML-based VTK file that can be opened with ParaView')
    ...
    parser.add_argument('--interp', default=-1, type=int,
                        help='Interpolate the surface to this resolution (1000 recommended)')
