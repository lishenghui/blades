...
from typing import Any, Callable, List, TypeVar, Optional, Dict, Type, Tuple, Union
...
class WorkerGroup:
    ...
    def __init__(
        ...
        eager_install: Optional[bool] = True,
    ):
        if num_workers <= 0:
            raise ValueError(
    ...
    def foreach_worker(self, func: Callable[[Worker], T]) -> List[T]:
