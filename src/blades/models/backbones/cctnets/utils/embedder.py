...
class Embedder(nn.Module):
    def __init__(self,
        ...
        self.embeddings = nn.Embedding.from_pretrained(pretrained_weight,
                                                       freeze=embed_freeze) \
            if pretrained_weight is not None else nn.Embedding(vocab_size, word_embedding_dim, padding_idx=padding_idx,)
