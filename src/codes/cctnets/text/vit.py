...
def _text_vit(num_layers, num_heads, mlp_ratio, embedding_dim,
...
def text_vit_2(*args, **kwargs):
    return _text_vit(num_layers=2, num_heads=2, mlp_ratio=1, embedding_dim=128,
                     *args, **kwargs)


def text_vit_4(*args, **kwargs):
    return _text_vit(num_layers=4, num_heads=2, mlp_ratio=1, embedding_dim=128,
                     *args, **kwargs)


def text_vit_6(*args, **kwargs):
    return _text_vit(num_layers=6, num_heads=4, mlp_ratio=2, embedding_dim=256,
                     *args, **kwargs)
