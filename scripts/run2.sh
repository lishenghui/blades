...
run_all_aggs() {
    ...
    do
        ...
        do
            args="--dataset $1 --algorithm $2 --global_round $3 --local_round $4  --agg $5 $6 --num_gpus 4 --num_byzantine 5 --use-cuda --batch_size 64 --seed 128 --serv_momentum $serv_momentum --attack $attack"
            echo ${args}
