...
run_all_aggs() {
    ...
    do
        for serv_momentum in 0.0 0.5 0.95 #1 3 5 7 9
        do
            args="--dataset $1 --algorithm $2 --global_round $3 --local_round $4  --agg $5 $6 --num_gpus 4 --use-cuda --batch_size 64 --seed 0 --serv_momentum $serv_momentum --attack $attack"
            echo ${args}
            python main.py ${args}
        done
    done
